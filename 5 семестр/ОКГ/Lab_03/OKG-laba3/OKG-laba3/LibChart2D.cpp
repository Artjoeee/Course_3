...
void CPlot2D::Draw(CDC& dc, int Ind1, int Ind2)
{
    ...
    if (Ind2 == 1)
    {
        ...
        double baseY;
        if (niceY < 1.5) baseY = 1.0;
        else if (niceY < 3.0) baseY = 2.0;
        else if (niceY < 7.0) baseY = 5.0;
        else baseY = 10.0;
        ...
        double baseX;
        if (niceX < 1.5) baseX = 1.0;
        else if (niceX < 3.0) baseX = 2.0;
        else if (niceX < 7.0) baseX = 5.0;
        else baseX = 10.0;
