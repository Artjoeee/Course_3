...
namespace ht    // HT API
{
	...
	{
		Element();
		Element(const void* key, int keyLength);                                             // get
		Element(const void* key, int keyLength, const void* payload, int  payloadLength);    // insert
		Element(const Element* oldElement, const void* newPayload, int  newPayloadLength);   // update
