...
insert into PULPIT   (PULPIT,    PULPIT_NAME,                                                   FACULTY )
             values  ('ИСиТ',    'Иформационных систем и технологий ',                         'ИТ'  );
insert into PULPIT   (PULPIT,    PULPIT_NAME,                                                   FACULTY )
...
(
    AUDITORIUM_TYPE   char(60) constraint AUDITORIUM_TYPE_PK  primary key,  
...
ADD CONSTRAINT FK_AUDITORIUM_TYPE
...
SELECT AUDITORIUM_CAPACITY FROM AUDITORIUM WHERE AUDITORIUM_NAME='206-1';
...
SELECT constraint_name, constraint_type, status
FROM user_constraints
WHERE table_name IN ('AUDITORIUM', 'AUDITORIUM_TYPE');
